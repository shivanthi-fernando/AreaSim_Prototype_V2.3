        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              readOnly
              value={detectedCity || ""}
              className="w-full rounded-xl border border-[#D1D1D1] bg-[#F5F5F5] px-4 py-2.5 text-sm text-[#222B27] font-body placeholder:text-[#98A1B2] cursor-default opacity-60 transition-all duration-200"
            />
          </div>
        </div>
      </motion.div>
