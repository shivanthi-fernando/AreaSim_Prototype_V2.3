...
const inputCls =
  "w-full rounded-[10px] border border-[#AEAEAE] bg-surface pl-10 py-2.5 text-sm text-text font-body placeholder:text-text-muted/60 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 hover:border-[#8B8B8B] transition-all";
